//
//  BranchLayoutSectionBuilder.swift
//  CSClone
//
...
class BranchLayoutSectionBuilder {
...
//            NSCollectionLayoutDecorationItem.background(elementKind: BranchBackgroundDecoration.reuseIdentifier)
//        ]
